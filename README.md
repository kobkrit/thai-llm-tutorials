...
โค้ด โน้ตบุ๊ก และชุดข้อมูล KobEval-TH เผยแพร่ภายใต้ **[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)** — ดู [LICENSE](LICENSE)

แปลว่า: นำไปใช้ ดัดแปลง และเผยแพร่ต่อได้ โดย (1) อ้างอิงที่มา (2) **ไม่ใช้เพื่อการค้า** (3) เผยแพร่งานที่ดัดแปลงด้วยสัญญาเดียวกัน

สัญญานี้ครอบคลุมเฉพาะเนื้อหาที่เขียนขึ้นสำหรับคอร์สนี้ ส่วนโมเดลและชุดข้อมูลของบุคคลที่สามที่โน้ตบุ๊กเรียกใช้ ยังคงใช้สัญญาของเจ้าของเดิม (ดูใน LICENSE)
